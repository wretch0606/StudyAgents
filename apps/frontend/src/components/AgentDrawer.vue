      ...
      <el-scrollbar class="drawer-scroll">
        ...
        <template v-else>
          <div class="drawer-section">
            ...
            <div v-for="ref in sourceRefs" :key="ref.document_id" class="source-card">
              <div class="source-head">
                <span class="source-ref-badge">[{{ ref.document_id }}]</span>
                <span class="source-doc">{{ ref.document_name }}</span>
                <span class="source-page">第 {{ ref.page_no }} 页</span>
              </div>
              ...
              <div class="source-footer">
                ...
                <span class="source-chunk-id">chunk: {{ ref.document_id }}</span>
              </div>
            </div>
          </div>
        </template>
